...
The current office build is available from [Bigroute 1.3.3 Office](https://github.com/tufw95/bigroute/releases/tag/office-v1.3.3):
...
```bash
git tag -a office-v1.3.3 -m "Bigroute 1.3.3"
git push origin office-v1.3.3
```
